...
| OpenAI model IDs/prices in settings are placeholders pending live project proof | unverified | settings.example.yaml | 2026-08-15 | llm | before pilot with real key | deterministic fallback report |
